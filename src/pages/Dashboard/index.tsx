...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    async function loadTransactions(): Promise<void> {
      ...
      const parsedTransactions = response.data.transactions.map(transaction => {
        const parsedTransaction = transaction;
        parsedTransaction.formattedValue = formatValue(transaction.value);
        parsedTransaction.formattedDate = format(
          parseISO(parsedTransaction.created_at),
          'dd/MM/yyyy',
        );
